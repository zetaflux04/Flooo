...
const testimonials = [
  {
    ...
    location: "Noida, UP",
    text: "As a father of two, safe drinking water is essential for us. Flooo delivers every week on time, and the 1-litre packs are perfect for our home.",
    rating: 5,
  },
  {
    name: "Priya Malhotra",
    ...
    text: "We switched to Flooo six months ago. The RO+UV purification tastes clean, and the delivery team is always polite when they call to confirm.",
    rating: 5,
  },
  {
    name: "Amit Patel",
    ...
    text: "I stock Flooo at my shop for the neighbourhood. Customers trust the BIS certification, and the quality stays consistent in every batch.",
    rating: 5,
  },
  {
    name: "Kavita Singh",
  ...
  },
  {
    ...
    location: "Delhi NCR",
    text: "My parents can taste the difference with mineral-enriched water. Flooo has been our trusted brand for over a year — highly recommended.",
    rating: 5,
  },
  {
    name: "Ananya Reddy",
    role: "Young Parent",
    location: "Noida, UP",
    text: "The 250ml packs are ideal for school tiffins. Sealed, fresh, and easy to order — Flooo makes healthy hydration simple for busy families.",
    rating: 5,
  },
];
